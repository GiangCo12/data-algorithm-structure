...
class PetList:
    ...
    def check_exist(self, nickname):
        ...
        tmp = self._head
        while tmp:
            if tmp.get_element().get_nickname() == nickname:
                return tmp
            tmp = tmp.get_next()
        return None
    ...
    def search(self, name):
        ...
        tmp = self._head
        while tmp:
            if name in tmp.get_element().get_nickname():
                result.append(tmp)
            tmp = tmp.get_next()
        return result
    ...
    def remove_first(self):
        ...
        answer = self._head.get_element()  # write your code here
        self._head = self._head.get_next()  # write your code here
        self._size -= 1  # write your code here
...
def add_pet(input_pet_list):
    ...
    print('Code for handling \'Add a new pet\'')
    nickname = input('Input nickname: ')
    age = input('Input age: ')
    weight = input('Input weight: ')

    # Check duplicate before insertion.
    pet_in_list = input_pet_list.check_exist(nickname)
    if not pet_in_list:
        pet_list.add_first(Pet(nickname, age, weight))
        print("Pet added successfully")
    else:
        print("Cannot insert! Pet is duplicated")

    # Update size of the pet list

    print(f'Currently, {input_pet_list.get_size()} in this pet list')
    # ---------- End you code here-------------


# Task 2: Display all pets in the list
def display_pet(input_pet_list):
    # Hint:
    #   1. implement 'print_pet()' in the class PetList
    #   2. call the method 'print_pet()' here
    # LOC: 1-3
    # ---------- Write your code here----------
    input_pet_list.print_pet()
...
def search_pet(input_pet_list):
    ...
    print("Code for handling \'Search Pet\'")
    search_name = input("Enter the name to search: ")
    search_result = input_pet_list.search(search_name)

    for pet in search_result:
        pet.get_element().display()
    # ---------- End you code here-------------
...
def update_pet(input_pet_list):
    ...
    print("Code for handling the task of updating pet info")

    pet_name = input("Enter name of the pet need to be updated: ")
    pet_node = input_pet_list.check_exist(pet_name)
    if pet_node:
        new_age = input("New age: ")
        new_weight = input("New weight: ")
        pet_node.get_element().set_age(new_age)
        pet_node.set_weight(new_weight)
    else:
